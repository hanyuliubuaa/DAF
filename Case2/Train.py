...
Train_data_list = np.loadtxt("data2/Train_data.txt", dtype='float32')
Train_label_list = np.loadtxt("data2/Train_label.txt", dtype='float32')
...
# Test data and label
Test_data_list = np.loadtxt("data2/Test_data.txt", dtype='float32')
Test_label_list = np.loadtxt("data2/Test_label.txt", dtype='float32')
...
# model.load_state_dict(torch.load('Case2/model/PDAF1.pt'))
